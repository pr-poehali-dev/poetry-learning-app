...
type Screen = "catalog" | "learn" | "listen" | "stats" | "settings";
            ...
            <div className="bg-[#141416] border border-[#1e1e22] p-5 mb-4">
              ...
              {voiceState === "listening" && (
                <div className="flex flex-col items-center py-3 gap-3">
                  ...
                  <p className="text-[#c9a96e] text-sm">Говорите стихотворение...</p>
                </div>
              )}
                ...
                <div className="flex flex-col items-center py-3 gap-3">
                  <div className="flex gap-1">
                    {[0, 1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className="w-1 bg-[#c9a96e]/60 animate-pulse rounded-full"
                        style={{
                          height: `${20 + Math.abs(Math.sin(i)) * 12}px`,
              ...
              {voiceState === "done" && voiceScore && (
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                      onClick={() => { setVoiceState("idle"); setVoiceScore(null); }}
            ...
            <div className="flex gap-3">
              {currentStrophe > 0 && (
                <button
                  ...
                  className="px-4 py-3 border border-[#2a2a2e] text-[#555] hover:text-[#888] hover:border-[#333] transition-all text-sm"
                >
        ...
        {screen === "listen" && (
          <div className="px-6 pt-12">
            <div className="mb-10">
              ...
              <h1 className="font-cormorant text-4xl font-light text-[#e8e4dc]">
                Эталонное<br />чтение
              </h1>
            </div>
                    ...
                    <div className="px-4 pb-4">
                      ...
                      <div className="flex justify-center gap-0.5">
                        {Array.from({ length: 40 }).map((_, i) => (
                          <div
                            key={i}
                            className="w-0.5 bg-[#c9a96e]/40 rounded-full animate-pulse"
                            style={{
                              height: `${8 + Math.abs(Math.sin(i * 0.6)) * 20}px`,
            ...
            <div className="bg-[#141416] border border-[#1e1e22] p-5">
              <p className="text-[#555] text-xs tracking-wider uppercase mb-4">Текст при прослушивании</p>
              ...
              <div className="flex items-end gap-2 h-24">
                {[71, 87, 94, 100, 88, 92, 85].map((val, i) => (
                  <div key={i} className="flex-1 flex flex-col items-center gap-1">
                    <div
                      className="w-full bg-[#c9a96e]/80 rounded-sm"
